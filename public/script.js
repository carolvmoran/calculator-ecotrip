...
function showResult(data) {
    ...
    document.getElementById('result-transporte').textContent = transporteNomes[data.transporte] || data.transporte;
    ...
    if (data.transporte === 'bicicleta' || data.emissaoCO2 === 0) {
        ...
        document.getElementById('trees-equivalent').textContent = data.arvoresNecessarias;
...
form.addEventListener('submit', async (e) => {
    ...
    if (!manualDistanceCheckbox.checked || !formData.distancia || formData.distancia <= 0) {
